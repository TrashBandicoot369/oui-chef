...
export default function MobileEventHighlights() {
  ...
  const onTouchEnd = () => {
    ...
    if (isLeftSwipe && count > 0) {
      setIndex((i) => (i + 1) % count)
    }
    if (isRightSwipe && count > 0) {
  ...
  if (!eventsData || events.length === 0) {
    return (
      <div className="w-full min-h-[600px] flex items-center justify-center relative overflow-hidden px-4">
  ...
  return (
    <div 
      ref={containerRef}
      className="w-full min-h-[600px] flex flex-col items-center justify-start relative overflow-hidden px-4 py-8"
    ...
    >
      ...
      <div className="absolute top-1/2 left-4 right-4 flex justify-between items-center z-20 pointer-events-none">
        <button
          onClick={prev}
          aria-label="Previous"
          className="flex-shrink-0 p-2 bg-white bg-opacity-20 rounded-full pointer-events-auto"
        >
      ...
      <div className="relative w-full max-w-md mx-auto">
        ...
        <div className="relative w-full h-[400px] flex items-center justify-center">
          <svg
            ...
            className="w-full h-full max-w-[350px] max-h-[350px] pointer-events-none"
            clipPathUnits="userSpaceOnUse"
          >
            <defs>
              <clipPath id="morphClipMobile">
                <path 
                  ref={pathRef} 
                  d={shapes[0]} 
                  fill="#fff"
        ...
        <div className="relative -mt-32 z-10 px-6 pt-24 pb-6">
